...
[shortcuts-api]: @ref xkb_server_options::xkb_server_options_shortcuts_set_mapping
...
<dl>
<dt>
`xkb_server_options::xkb_server_options_shortcuts_update_mods()`
</dt>
<dd>
...
if (xkb_server_options_shortcuts_update_mods(options, shortcuts_mask, shortcuts_mask)) {
    /* handle error */
    …
}
```
...
<dt>
`xkb_server_options::xkb_server_options_shortcuts_set_mapping()`
</dt>
<dd>
...
```c
if (xkb_server_options_shortcuts_set_mapping(options, 0, 1)) {
    /* handle error */
    …
}
```
...
for (xkb_layout_index_t source = 1; source < num_layouts; source++) {
    if (xkb_server_options_shortcuts_set_mapping(options, source, 0)) {
        /* handle error */
        …
    }
}
