...
There are currently 75 entries.
...
| [XKB-984] | `invalid-canonical-key-type` | Canonical key types have mandatory properties defined in the XKB protocol | Error |
...
### XKB-984 – Invalid canonical key type {#XKB-984}

<dl>
  <dt>Since</dt><dd>1.13.0</dd>
  <dt>Type</dt><dd>Error</dd>
  <dt>Summary</dt><dd>Canonical key types have mandatory properties defined in the XKB protocol</dd>
</dl>

See the [canonical key types specification] in the XKP protocol.

[canonical key types specification]: https://www.x.org/releases/current/doc/kbproto/xkbproto.html#canonical_key_types
