...
There are currently 68 entries.
...
| [XKB-746] | `unsupported-keymap-compilation-flag` | Unsupported keymap compilation flag | Error |
...
| [XKB-825] | `unsupported-keymap-text-format` | Keymap text format is not supported | Error |
...
### XKB-746 – Unsupported keymap compilation flag {#XKB-746}

<dl>
  <dt>Since</dt><dd>1.0.0</dd>
  <dt>Type</dt><dd>Error</dd>
  <dt>Summary</dt><dd>Unsupported keymap compilation flag</dd>
</dl>

See `xkb_keymap_compile_flags` for the supported keymap compilation flags.
...
### XKB-825 – Unsupported keymap text format {#XKB-825}

<dl>
  <dt>Since</dt><dd>1.0.0</dd>
  <dt>Type</dt><dd>Error</dd>
  <dt>Summary</dt><dd>Keymap text format is not supported</dd>
</dl>

See `xkb_keymap_format` for the supported keymap text formats.
