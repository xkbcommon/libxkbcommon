...
There are currently 98 entries.
...
| [XKB-113] | `event-type-mismatch` | Event getter does not match the event’s type | Error |
...
| [XKB-538] | `invalid-keycode` | Invalid keycode | Error |
...
### XKB-113 – Event type mismatch {#XKB-113}

<dl>
  <dt>Since</dt><dd>1.14.0</dd>
  <dt>Type</dt><dd>Error</dd>
  <dt>Summary</dt><dd>Event getter does not match the event’s type</dd>
</dl>
...
### XKB-538 – Invalid keycode {#XKB-538}

<dl>
  <dt>Since</dt><dd>1.0.0</dd>
  <dt>Type</dt><dd>Error</dd>
  <dt>Summary</dt><dd>Invalid keycode</dd>
</dl>
