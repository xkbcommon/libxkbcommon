...
_xkbcli_commands() {
	local -a commands=(
		...
		'dump-keymap:dump an XKB keymap from a Wayland or X11 compositor'
		'dump-keymap-wayland:dump an XKB keymap from a Wayland compositor'
		'dump-keymap-x11:dump an XKB keymap from an X server'
