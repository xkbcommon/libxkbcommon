...
static const struct xkb_message_entry xkb_messages[] = {
    ...
    {XKB_ERROR_UNSUPPORTED_KEYMAP_COMPILATION_FLAG, "Unsupported keymap compilation flag"},
    ...
    {XKB_ERROR_UNSUPPORTED_KEYMAP_TEXT_FORMAT, "Unsupported keymap text format"},
