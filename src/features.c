...
static bool
is_supported_flag_value(enum xkb_enumerations_values values, int value)
{
    return ((int) values & value) == value;
}
...
xkb_has_feature(enum xkb_feature feature, int value)
{
    ...
    case XKB_FEATURE_ENUM_FEATURE:
        return is_supported_enum_value_array(
            xkb_feature_values,
            ARRAY_SIZE(xkb_feature_values),
            value
        );
    case XKB_FEATURE_ENUM_RMLVO_BUILDER_FLAGS:
        return is_supported_flag_value(XKB_RMLVO_BUILDER_FLAGS_VALUES, value);
    case XKB_FEATURE_ENUM_KEYSYM_FLAGS:
        return is_supported_flag_value(XKB_KEYSYM_FLAGS_VALUES, value);
    case XKB_FEATURE_ENUM_CONTEXT_FLAGS:
        return is_supported_flag_value(XKB_CONTEXT_FLAGS_VALUES, value);
    ...
    case XKB_FEATURE_ENUM_KEYMAP_COMPILE_FLAGS:
        return is_supported_flag_value(XKB_KEYMAP_COMPILE_FLAGS_VALUES, value);
    case XKB_FEATURE_ENUM_KEYMAP_FORMAT:
        return value && is_supported_flag_value(XKB_KEYMAP_FORMAT_VALUES, value);
    case XKB_FEATURE_ENUM_KEYMAP_SERIALIZE_FLAGS:
        return is_supported_flag_value(XKB_KEYMAP_SERIALIZE_FLAGS_VALUES, value);
    case XKB_FEATURE_ENUM_KEYMAP_KEY_ITERATOR_FLAGS:
        return is_supported_flag_value(XKB_KEYMAP_KEY_ITERATOR_FLAGS_VALUES, value);
    case XKB_FEATURE_ENUM_STATE_ACCESSIBILITY_FLAGS:
        return is_supported_flag_value(XKB_STATE_ACCESSIBILITY_FLAGS_VALUES, value);
    ...
    case XKB_FEATURE_ENUM_STATE_COMPONENT:
        return value && is_supported_flag_value(XKB_STATE_COMPONENT_VALUES, value);
    case XKB_FEATURE_ENUM_KEYBOARD_CONTROLS:
        return is_supported_flag_value(XKB_KEYBOARD_CONTROLS_VALUES, value);
    case XKB_FEATURE_ENUM_KEY_DIRECTION:
        return is_supported_flag_value(XKB_KEY_DIRECTION_VALUES, value);
    case XKB_FEATURE_ENUM_STATE_MATCH:
        return value && is_supported_flag_value(XKB_STATE_MATCH_VALUES, value);
    case XKB_FEATURE_ENUM_CONSUMED_MODE:
        return is_supported_flag_value(XKB_CONSUMED_MODE_VALUES, value);
    case XKB_FEATURE_ENUM_COMPOSE_COMPILE_FLAGS:
        return is_supported_flag_value(XKB_COMPOSE_COMPILE_FLAGS_VALUES, value);
    case XKB_FEATURE_ENUM_COMPOSE_FORMAT:
        return value && is_supported_flag_value(XKB_COMPOSE_FORMAT_VALUES, value);
    case XKB_FEATURE_ENUM_COMPOSE_STATE_FLAGS:
        return is_supported_flag_value(XKB_COMPOSE_STATE_FLAGS_VALUES, value);
    ...
    case XKB_FEATURE_ENUM_COMPOSE_FEED_RESULT:
        return is_supported_flag_value(XKB_COMPOSE_FEED_RESULT_VALUES, value);
    default:
        /* Invalid feature */
        return false;
    }
