...
class KeymapTestTemplate(TestTemplate):
    ...
    def _generate_tests(self) -> Generator[Test]:
        ...
        for keycodes, types, compat, symbols in zip(*(g.tests for g in groups)):
            ...
            expexted = KeymapTemplate.substitute(
            ...
            yield Test(title=title, file=file, content=content, expected=expexted)
...
KEYCODES_TESTS = ComponentTestTemplate(
    "Keycodes",
...
TYPES_TESTS = ComponentTestTemplate(
    ...
    base_template=ComponentTemplate(
        ...
        ${mode}virtual_modifiers U1, U2, U3, U4, U5, U6;
        ${mode}virtual_modifiers Z1=none, Z2=none, Z3=none, Z4=none, Z5=none, Z6=none;
        ${mode}virtual_modifiers M1=0x1000, M2=0x2000, M3=0x3000, M4=0x4000, M5=0x5000, M6=0x6000;
    ...
    augment="""
        ...
        virtual_modifiers U1,U2,U3=0x300000,U4,U5,U6=0x600000;
        virtual_modifiers Z1,Z2,Z3=0x310000,Z4,Z5,Z6=0x610000;
        virtual_modifiers M1=0x1000,M2=0x2000,M3=0x3000,M4=0x4000,M5=0x5000,M6=0x6000;
        virtual_modifiers U7,Z7,M7=0x700000;
    ...
    override="""
        ...
        virtual_modifiers U1,U2,U3=0x300000,U4,U5,U6=0x600000;
        virtual_modifiers Z1,Z2,Z3=0x310000,Z4,Z5,Z6=0x610000;
        virtual_modifiers M1=0x1000,M2,M3=0x320000,M4=0x4000,M5,M6=0x620000;
        virtual_modifiers U7,Z7,M7=0x700000;
