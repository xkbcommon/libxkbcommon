 ...
 *   unversioned), listed in lexicographic order. The extensions directories are
 *   defined by the environment variables `XKB_CONFIG_VERSIONED_EXTENSIONS_PATH`
 *   and `XKB_CONFIG_UNVERSIONED_EXTENSIONS_PATH` and defaults to the system XKB
 *   root extensions directory, defined at library configuration time (usually
