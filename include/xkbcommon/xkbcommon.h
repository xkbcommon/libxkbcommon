 ...
 *
 * See @ref keymap-text-format-v1-2 "" for further information.
 */
enum xkb_keymap_format {
    /**
     * The classic XKB text format, as generated by `xkbcomp -xkb`.
     *
     * @important This format should always be used when *serializing* a keymap
     * for **X11**.
     */
     ...
     * X11**.
     *
     * @todo List incompatibilities
     *
     * @important Do *not* use when *serializing* a keymap for **X11**
     * (incompatible).
     * @important Use with *care* when *serializing* for **Wayland**: at the
     * time of writing (2025-05-07), there is no Wayland API for keymap format
     * *negotiation*, so the clients may not be able to parse the keymap if it
     * uses v2-specific features.
     *
     * @since 1.10.0
     */
 ...
 * @since 1.10.0: Deprecated
 * @since 1.10.0: Use internally `::XKB_KEYMAP_FORMAT_TEXT_V2` instead of
