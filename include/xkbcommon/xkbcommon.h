 ...
 * Opaque keymap compilation options object.
 *
 * @since 1.10.0
 */
struct xkb_keymap_compile_options;
...
/**
 * Create a keymap compile options object, to be used with the various keymap
 * compilation functions.
 *
 * @memberof xkb_keymap
 * @sa xkb_keymap_compile_options_free()
 * @sa xkb_keymap_new_from_names2()
 * @sa xkb_keymap_new_from_file2()
 * @sa xkb_keymap_new_from_buffer2()
 * @since 1.10.0
 */
 ...
 *
 * @memberof xkb_keymap
 * @sa xkb_keymap_compile_options_new()
 * @since 1.10.0
 */
XKB_EXPORT void
 ...
 * Create a keymap from [RMLVO] names.
 *
 * Same as xkb_keymap_new_from_names() but with the keymap compile options API.
 *
 * This function is intended for *server* applications.
 *
 * @param context The context in which to create the keymap.
 * @param names   The [RMLVO] names to use.  See xkb_rule_names.
 ...
 * Create a keymap from a keymap file.
 *
 * Same as xkb_keymap_new_from_file() but with the keymap compile options API.
 *
 * This function is intended for *server* applications.
 *
 * @param context The context in which to create the keymap.
 ...
 *
 * @see xkb_keymap_new_from_string(), xkb_keymap_new_from_buffer2()
 * @memberof xkb_keymap
 * @since 0.3.0
 */
XKB_EXPORT struct xkb_keymap *
 ...
 * Create a keymap from a memory buffer.
 *
 * Same as xkb_keymap_new_from_buffer() but with the keymap compile options API.
 *
 * This function is intended for *server* applications.
 *
 * @see xkb_keymap_new_from_string(), xkb_keymap_new_from_buffer()
 * @memberof xkb_keymap
 * @since 1.10.0
 */
XKB_EXPORT struct xkb_keymap *
 ...
 * @sa xkb_keymap_format, xkb_keymap::xkb_keymap_get_as_string()
 **/
