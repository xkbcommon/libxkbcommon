 ...
 * Utility functions related to *rules*, which purpose is introduced in:
 * @ref xkb-the-config "".
 *
 * @{
 */
 ...
 * @param[out] rmlvo_out  The [RMLVO] names actually used after resolving missing
 * values.
 * @param[out] components The [KcCGST] components resulting of the [RMLVO]
 * resolution.
 *
