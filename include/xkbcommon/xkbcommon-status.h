...
#ifndef _XKBCOMMON_STATUS_H_
#define _XKBCOMMON_STATUS_H_
...
/**
 * @defgroup error-api Status and error handling
 * Status codes and error handling features.
 *
 * @{
 */
 ...
 * - Any other value indicates that the operation *failed* with a specific
 *   error condition.
 *
